...
public class RestaurantDetailsInsertServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isError){
			...
			resataurantDetailsBean.setState_id(State);
			...
			if(new RestaurantDetailsDAO().insert(resataurantDetailsBean)){
