...
<body>
<form action="hotelDetailsInsert">
	<table>
		<tr>
		<th>Hotel-name</th>
		<td>:</td>
		<td><input type="text" name="txtHotel" id="txtHotel">${hotel}</td>
		</tr>
		...
		<th>Description</th>
		<td>:</td>
		<td><textarea cols="5" rows="3" name="txtDescription" id="txtDescription">${description}</textarea></td>
		</tr>
		...
		<th>Website</th>
		<td>:</td>
		<td><input type="text" name="txtWebsite" id="txtWebsite">${website}</td>
		</tr>
		
		<tr>
		<th>Charge</th>
		<td>:</td>
		<td><input type="text" name="txtCharge" id="txtCharge">${charge}</td>
		</tr>
