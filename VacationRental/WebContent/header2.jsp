        ...
        <div class="container">
            ...
            <div class="pull-right">
                <ul class="topbar-social list-inline">
                    ...
                    <li><a href="userPanel.jsp">Welcome, <%=userSession.getFirst_name()+" "+userSession.getLast_name()%></a></li>
                    ...
                    <nav id="navigation" class="navbar" role="navigation">
                        <div class="navbar-inner">
                            <div class="navbar-header">
                                ...
                                <a id="brand" class="clearfix navbar-brand" href="index.jsp"><img src=images/logo.png alt="Trips">&nbsp<h3><span>Vacation</span> Trip</a>
                            ...
                            <div id="navbar-collapse" class="navbar-right navbar-collapse collapse clearfix">
                              <ul class="nav navbar-nav yamm">
                                ...
                                </ul><!-- end navbar-right -->                            </div><!-- end navbar-callopse -->
                    ...
                    <nav id="navigation" class="navbar" role="navigation">
                        <div class="navbar-inner">
                            <div class="navbar-header">
                                ...
                                <a id="brand" class="clearfix navbar-brand" href="index.jsp"><img src="images/logo.png" alt="Trips">&nbsp<h3><span>Vacation</span> Trip</h3></a>
                            </div><!-- end navbar-header -->
                            <div id="navbar-collapse" class="navbar-right navbar-collapse collapse clearfix">
                                <ul class="nav navbar-nav yamm">
                                    <li class="dropdown">
