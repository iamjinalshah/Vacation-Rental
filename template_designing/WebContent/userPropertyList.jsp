	...
	<section class="content">
            ...
            <div class="col-lg-2 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="userPropertyList?userId=<%=userSession.getUser_id()%>" class="small-box-footer">All info <i class="fa fa-arrow-circle-down"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-2 col-xs-6">
              <!-- small box -->
				...
				<table border="1" class="table table-hover">
					...
					<tr>
						...
						<td><%=propertyDetailsBean.getType_name()%></td>
						 ...
						 <%-- <a href="propertyDetailsEdit?propertyId=<%=propertyDetailsBean.getProperty_id()%>">
						 <input type="button" name="EDIT" value="EDIT" class="btn btn-primary"></a>
							<a href="propertyDetailsDelete?propertyId=<%=propertyDetailsBean.getProperty_id()%>"><input
								type="button" name="DELETE" value="DELETE" class="btn btn-danger"></a>
							<a href="PropertyPhoto.jsp?propertyId=<%=propertyDetailsBean.getProperty_id()%>"><input
								type="button" name="photo" value="Add photo" class="btn btn-info"></a>
								<a href="PropertyDetailsAmenities.jsp?propertyId=<%=propertyDetailsBean.getProperty_id()%>"><input
								type="button" name="Amenities" value="Add Amenities" class="btn btn-warning"></a> --%>
