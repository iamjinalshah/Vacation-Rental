...
<section id="page-header" class="section background">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3>Car Rentals of <%=request.getAttribute("search") %></h3>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
 </section><!-- end section -->
                            ...
                            <div class="post-wrapper clearfix border-bottom">
                                <div class="hotel-wrapper">
                                    <div class="post-media">
                                        <!-- <a href="hotel-single.html"><img src="upload/Idproof/" alt="car Image"  height="300px" width="300px"></a> -->
                                    </div><!-- end media -->
                                    <div class="post-title clearfix">
                                        <div class="pull-left">
                                            <h5><a href="hotel-single.html" title="">Car Manager: <%=carDetailsBean.getManager_name()%></a></h5>
                                       		<span>(<%=carDetailsBean.getCity_name()%>)</span>
                                        </div><!-- end left -->
