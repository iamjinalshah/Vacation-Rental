...
<section id="page-header" class="section background">
        <div class=	"container">
            <div class="row">
                <div class="col-sm-12">
                    <h3><%=propertyDetailsBean.getProperty_title()%></h3>
                    <p>
                    <span class="rating">
                    ...
                    <%=propertyDetailsBean.getAddress()%>(<%=propertyDetailsBean.getCity_name()%>,<%=propertyDetailsBean.getState_name()%>)</p>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
    </section><!-- end section -->
                ...
                <div id="fullwidth" class="col-sm-12">
                    ...
                    <div class="single-hotel-wrapper">
                        <div class="single-hotel-image">
                            <img src="upload/Property/<%=propertyDetailsBean.getPhoto()%>" alt="" height="682px" width="1170px">
                            <div class="price">
                                <h6>Rate</h6>
                                <h2><small>Rs </small><%=propertyDetailsBean.getRate()%><span>/DAY</span></h2>
                                <a href="#" class="btn btn-primary btn-lg">BOOK NOW</a>
                            </div><!-- end price -->
							
                            <div class="thumbnails">
                            <%List<PropertyPhotoBean> listOfPropertyPhotos = (ArrayList)request.getAttribute("listOfPropertyPhotos"); 
							if(listOfPropertyPhotos!=null){
								for(int i=0;i<listOfPropertyPhotos.size();i++){
									PropertyPhotoBean propertyPhotoBean = listOfPropertyPhotos.get(i); 
							%>
                                <a data-gal="prettyPhoto[product-gallery]" rel="bookmark" title="" href="upload/Property/<%=propertyPhotoBean.getPhoto_name()%>"><img src="upload/Property/<%=propertyPhotoBean.getPhoto_name()%>" alt="" class="img-responsive"></a>
                            <%}} %>
                            </div><!-- end price -->
                        ...
                        <div class="row">
                            <div id="content" class="col-md-9 col-sm-12 col-xs-12">
                                ...
                                <div class="related-hotels clearfix">
                                    ...
                                    <div class="row">
                                    <%List<PropertyDetailsBean> listOfAllProperty = new PropertyDetailsDAO().AllSearchlist();
                                    if(listOfAllProperty!=null){
                                    	for(int i=0;i<3;i++){
                                    		PropertyDetailsBean bean =listOfAllProperty.get(i); 
                                    %>
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="post-wrapper clearfix border-bottom">
                                                <div class="hotel-wrapper">
                                                    <div class="post-media">
                                                        <a href="propertyFullInfo?propertyId=<%=bean.getProperty_id()%>"><img src="upload/Property/<%=bean.getPhoto()%>" alt="" height="250px" width="300px"></a>
                                                    </div><!-- end media -->
                                                    <div class="post-title clearfix">
                                                        <div class="pull-left">
                                                            <h5><a href="propertyFullInfo?propertyId=<%=bean.getProperty_id()%>" title=""><%=bean.getProperty_title()%></a></h5>
                                                        </div><!-- end left -->
                                                        <div class="pull-right">
                                                            <h6>Rs <%=bean.getRate()%></h6>
                                                        </div><!-- end left -->
                                                    </div><!-- end title -->
                                                    <span class="rating">
                                                        <i class="fa fa-star"></i>
                            ...
                            <div id="sidebar" class="col-md-3 col-sm-12 col-xs-12">
                                <div class="widget clearfix">
                                    ...
                                    <div class="sidebar-price clearfix">
                                        <h6>Rate</h6>
                                        <h2><%=propertyDetailsBean.getRate()%><span>/DAY</span></h2>
                                        <a href="#" class="btn btn-primary btn-lg">BOOK NOW</a>
                                    </div><!-- end price -->
