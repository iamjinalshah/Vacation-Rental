...
<section id="page-header" class="section background">
        <div class=	"container">
            <div class="row">
                <div class="col-sm-12">
                    <h3><%=hotelDetailsBean.getHotel_name()%></h3>
                    <p>
                    <span class="rating">
                ...
                <div id="fullwidth" class="col-sm-12">
                    ...
                    <div class="single-hotel-wrapper">
                        <div class="single-hotel-image">
                            <img src="upload/hotel/<%=hotelDetailsBean.getHphoto_name()%>" alt="" height="682px" width="1170px">
                            <div class="price">
                                <h6>Room Charge</h6>
                                <h2><small>Rs </small><%=hotelDetailsBean.getCharge()%><span>/NIGHT</span></h2>
                                <a href="#" class="btn btn-primary btn-lg">BOOK NOW</a>
                            </div><!-- end price -->
							
                            <div class="thumbnails">
                            <%List<HotelPhotoBean> listOfHotelPhotos = (ArrayList)request.getAttribute("listOfHotelPhotos"); 
							if(listOfHotelPhotos!=null){
								for(int i=0;i<listOfHotelPhotos.size();i++){
									HotelPhotoBean photoBean = listOfHotelPhotos.get(i); 
							%>
                                <a data-gal="prettyPhoto[product-gallery]" rel="bookmark" title="" href="upload/hotel/<%=photoBean.getPhoto_name()%>"><img src="upload/hotel/<%=photoBean.getPhoto_name()%>" alt="" class="img-responsive"></a>
                            <%}} %>
                            </div><!-- end price -->
                        ...
                        <div class="row">
                            <div id="content" class="col-md-9 col-sm-12 col-xs-12">
                                ...
                                <div class="related-hotels clearfix">
                                    ...
                                    <div class="row">
                                    <%List<HotelDetailsBean> listOfAllHotels = new HotelDetailsDAO().AllSearchlist();
                                    if(listOfAllHotels!=null){
                                    	for(int i=0;i<3;i++){
                                    	HotelDetailsBean bean =listOfAllHotels.get(i); 
                                    %>
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="post-wrapper clearfix border-bottom">
                                                <div class="hotel-wrapper">
                                                    <div class="post-media">
                                                        <a href="hotelFullInfo?hotelId=<%=bean.getHotel_id()%>"><img src="upload/hotel/<%=bean.getHphoto_name()%>" alt="" height="250px" width="300px"></a>
                                                    </div><!-- end media -->
                                                    <div class="post-title clearfix">
                                                        <div class="pull-left">
                                                            <h5><a href="hotelFullInfo?hotelId=<%=bean.getHotel_id()%>" title=""><%=bean.getHotel_name()%></a></h5>
                                                        </div><!-- end left -->
                                                        <div class="pull-right">
                                                            <h6>Rs <%=bean.getCharge()%></h6>
                                                        </div><!-- end left -->
                                                    </div><!-- end title -->
                                                    <span class="rating">
                                                        <i class="fa fa-star"></i>
                            ...
                            <div id="sidebar" class="col-md-3 col-sm-12 col-xs-12">
                                <div class="widget clearfix">
                                    ...
                                    <div class="sidebar-price clearfix">
                                        <h6>Room Charge</h6>
                                        <h2><%=hotelDetailsBean.getCharge()%><span>/NIGHT</span></h2>
                                        <a href="#" class="btn btn-primary btn-lg">BOOK NOW</a>
                                    </div><!-- end price -->
