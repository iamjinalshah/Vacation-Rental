...
<section id="page-header" class="section background">
        <div class=	"container">
            <div class="row">
                <div class="col-sm-12">
                    <h3><%=tourGuideBean.getFirst_name()+" "+tourGuideBean.getLast_name()%></h3>
                    <p>
                    <span class="rating">
                    ...
                    <%=tourGuideBean.getCity_name()%>,<%=tourGuideBean.getState_name()%></p>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
    </section><!-- end section -->
                ...
                <div id="fullwidth" class="col-sm-12">
                    ...
                    <div class="single-hotel-wrapper">
                        <div class="single-hotel-image">
                            <img src="upload/tourguide/<%=tourGuideBean.getPhoto()%>" alt="" height="682px" width="1170px">
                                ...
                                <div class="book-widget">
                                    ...
                                    %>
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <p><%=languageBean.getLanguage_Name()%></p>
                                        </div><!-- end col -->
									<%} }%>
 ...
 -->                                        </div><!-- end col -->
                                ...
                                <div class="related-hotels clearfix">
                                    ...
                                    <div class="row">
                                    <%List<TourGuideBean> listOftourguide = new TourGuideDAO().AllSearchlist();
                                    if(listOftourguide!=null){
                                    	for(int i=0;i<3;i++){
                                    		TourGuideBean bean =listOftourguide.get(i); 
                                    %>
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="post-wrapper clearfix border-bottom">
                                                <div class="hotel-wrapper">
                                                    <div class="post-media">
                                                        <a href="tourguideFullInfo?tourguideId=<%=bean.getTourguide_id()%>"><img src="upload/tourguide/<%=bean.getPhoto()%>" alt="" height="250px" width="300px"></a>
                                                    </div><!-- end media -->
                                                    <div class="post-title clearfix">
                                                        <div class="pull-left">
                                                            <h5><a href="tourguideFullInfo?tourguideId=<%=bean.getTourguide_id()%>" title=""><%=bean.getFirst_name()+" "+bean.getLast_name()%></a></h5>
                                                        </div><!-- end left -->
                                                    </div><!-- end title -->
                                                    <span class="rating">
                                                        <i class="fa fa-star"></i>
