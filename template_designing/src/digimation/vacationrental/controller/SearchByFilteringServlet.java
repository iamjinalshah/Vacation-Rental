...
public class SearchByFilteringServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("hotelRestaurantSearch")){
			...
			List<PropertyDetailsBean> listOfProperties = new PropertyDetailsDAO().Searchlist(search);
			...
			List<CarDetailsBean> listOfCar = new CarDetailsDAO().Searchlist(search);
			...
			List<AttractionBean> listOfAttraction = new AttractionDAO().Searchlist(search);
